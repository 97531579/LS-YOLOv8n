...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='runs/train/exp/best.pt', help='training model path')
    parser.add_argument('--data', type=str, default='ultralytics/oraldataset/data.yaml', help='data yaml path')
