...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='ultralytics/models/v5/yolov5n-EfficientHead.yaml', help='mode yaml path')
    ...
    parser.add_argument('--data', type=str, default='D:/yolov8-main/dataset/data.yaml', help='data yaml path')
